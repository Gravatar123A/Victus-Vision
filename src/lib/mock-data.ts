...
export const trendingServices = [
  {
    ...
    seller: { name: "Alex Chen", avatar: "/avatars/1.jpg", level: "Elite", verified: true },
    rating: 4.9,
    reviews: 342,
    price: 299,
    deliveryDays: 7,
  ...
  {
    id: "s2",
    title: "Modern UI/UX Design for Apps",
    seller: { name: "Sarah Kim", avatar: "/avatars/2.jpg", level: "Legend", verified: true },
    rating: 5.0,
    reviews: 521,
    price: 199,
    deliveryDays: 5,
  ...
  },
  {
    ...
    seller: { name: "Mike Torres", avatar: "/avatars/3.jpg", level: "Professional", verified: true },
    rating: 4.8,
    reviews: 189,
    price: 149,
    deliveryDays: 3,
    category: "Bots & Automation",
    image: "/services/discord-bot.jpg",
    tags: ["Discord.js", "Python", "Node.js"],
  },
  {
    id: "s4",
    title: "AI-Powered Content Generation",
    seller: { name: "Emma Davis", avatar: "/avatars/4.jpg", level: "Elite", verified: false },
    rating: 4.7,
    reviews: 156,
    price: 99,
    deliveryDays: 2,
    category: "AI & Machine Learning",
    image: "/services/ai-content.jpg",
    tags: ["GPT", "Content", "Automation"],
  },
  {
    id: "s5",
    title: "Professional Video Editing",
    seller: { name: "James Wilson", avatar: "/avatars/5.jpg", level: "Professional", verified: true },
    rating: 4.9,
    reviews: 278,
    price: 179,
    deliveryDays: 4,
    category: "Video & Animation",
    image: "/services/video-edit.jpg",
    tags: ["Premiere Pro", "After Effects"],
  },
  {
    id: "s6",
    title: "Full-Stack Mobile App Development",
    seller: { name: "Priya Patel", avatar: "/avatars/6.jpg", level: "Legend", verified: true },
    rating: 4.9,
    reviews: 412,
    price: 499,
    deliveryDays: 14,
...
export const featuredProducts = [
  {
    ...
    downloads: 1890,
    category: "Templates",
    image: "/products/dashboard-kit.jpg",
    tags: ["React", "TailwindCSS", "Dashboard"],
  },
  {
    id: "p2",
    title: "Advanced Discord Bot Framework",
    seller: { name: "BotMaster Inc", avatar: "/avatars/8.jpg" },
    price: 29,
    rating: 4.9,
    reviews: 567,
    downloads: 4320,
    category: "Scripts",
    image: "/products/bot-framework.jpg",
    tags: ["Discord", "Node.js", "Modular"],
  },
  {
    id: "p3",
    title: "E-Commerce Starter Template",
    seller: { name: "WebCraft Labs", avatar: "/avatars/9.jpg" },
    price: 79,
    rating: 4.7,
    reviews: 189,
    downloads: 2100,
  ...
  {
    id: "p4",
    title: "Motion Graphics Pack Vol. 2",
    seller: { name: "AnimateX", avatar: "/avatars/10.jpg" },
    price: 39,
    rating: 4.6,
    reviews: 145,
    downloads: 980,
    category: "Assets",
    image: "/products/motion-pack.jpg",
    tags: ["After Effects", "Premiere", "4K"],
  },
];
